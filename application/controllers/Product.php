...
class Product extends CI_Controller {
    ...
    public function save_product() {
        ...
        $this->form_validation->set_rules('publication_status', 'Publication Status', 'trim|required');
          ...
          if (!empty($_FILES['product_image1']['name'])) {
            ...
            if (!$this->upload->do_upload('product_image1')) {
                ...
                $data['product_image1'] = $post_image1['file_name'];
            }
            ...
            if (!$this->upload->do_upload('product_image2')) {
                ...
                $post_image2 = $this->upload->data();
                $data['product_image2'] = $post_image2['file_name'];
            }
            ...
            if (!$this->upload->do_upload('product_image3')) {
                ...
                $post_image3 = $this->upload->data();
                $data['product_image3'] = $post_image3['file_name'];
            }
        ...
        if (!$this->upload->do_upload('plan')) {
                ...
                $post_pdf = $this->upload->data();
                $data['plan'] = $post_pdf['file_name'];
            }
        }
    ...
    public function update_product($id) {
        ...
        $product_delete_image1 = $this->input->post('product_delete_image1');
        $product_delete_image2 = $this->input->post('product_delete_image2');
        $product_delete_image3 = $this->input->post('product_delete_image3');

        $delete_image1 = substr($product_delete_image1, strlen(base_url()));
        $delete_image2 = substr($product_delete_image2, strlen(base_url()));
        $delete_image3 = substr($product_delete_image3, strlen(base_url()));
     ...
     public function delete_product($id){
        ...
        unlink('uploads/'.$delete_image->product_image1);
        unlink('uploads/'.$delete_image->product_image2);
        unlink('uploads/'.$delete_image->product_image3);
    ...
    private function get_image_by_id($id){
        $this->db->select('product_image1','product_image2', 'product_image3');
