                    ...
                    <div class="nav-collapse sidebar-nav">
                        <ul class="nav nav-tabs nav-stacked main-menu">
                            <li><a href="<?php echo base_url('dashboard')?>"><i class="icon-bar-chart"></i><span class="hidden-tablet"> Dashboard</span></a></li>
                             <li><a href="<?php echo base_url('query/manage_query')?>"><i class="icon-envelope"></i><span class="hidden-tablet"> Queries</span></a></li>
                             <li><a href="<?php echo base_url('manage/category')?>"><i class="icon-tasks"></i><span class="hidden-tablet">  Categories</span></a></li>
                            ...
                            <li><a href="<?php echo base_url('manage/brand')?>"><i class="icon-list-alt"></i><span class="hidden-tablet">Brands</span></a></li>
                            <li><a href="<?php echo base_url('add/product')?>"><i class="icon-eye-open"></i><span class="hidden-tablet"> Add Product</span></a></li>
                            <li><a href="<?php echo base_url('manage/product')?>"><i class="icon-dashboard"></i><span class="hidden-tablet">  Products</span></a></li>
                          
                            <li><a href="<?php echo base_url('add/slider')?>"><i class="icon-font"></i><span class="hidden-tablet"> Add Slider</span></a></li>
                            <li><a href="<?php echo base_url('manage/slider')?>"><i class="icon-picture"></i><span class="hidden-tablet">  Sliders</span></a></li>
                            <li><a href="<?php echo base_url('theme/option');?>"><i class="icon-align-justify"></i><span class="hidden-tablet"> Theme Option</span></a></li>
                            <li><a href="<?php echo base_url('manage/order');?>"><i class="icon-calendar"></i><span class="hidden-tablet"> Orders</span></a></li>
                        </ul>
                    </div>
                </div>
                <!-- end: Main Menu -->
