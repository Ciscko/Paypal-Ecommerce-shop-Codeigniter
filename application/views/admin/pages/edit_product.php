                ...
                <form name="formName" class="form-horizontal" action="<?php echo base_url('update/product/'.$product_info_by_id->product_id);?>" method="post" enctype="multipart/form-data">
                    <fieldset>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input class="span6 typeahead" name="product_image1" id="fileInput" type="file"  >
                                ...
                                <input class="span6 typeahead" name="product_delete_image1" value="<?php echo base_url('uploads/'.$product_info_by_id->product_image1);?>" type="hidden"/>
                                <input class="span6 typeahead" name="product_delete_image2" value="<?php echo base_url('uploads/'.$product_info_by_id->product_image2);?>" type="hidden"/>
                                <input class="span6 typeahead" name="product_delete_image3" value="<?php echo base_url('uploads/'.$product_info_by_id->product_image3);?>" type="hidden"/>
                            </div>
                        </div>
                        
                        <div class="control-group">
                            <div class="controls">
                                <img src="<?php echo base_url('uploads/'.$product_info_by_id->product_image1);?>" style="width:500px;height:200px"/>
                            </div>
                        </div> 
