...
<head>
    ...
    <script type="text/javascript" src="<?php echo base_url() ?>assets/web/js/jquery-1.11.1.min.js"></script> 
...
<body>
    ...
    <div class="wrap">
        <div class="header_top">
            <div> <h1 style="text-align: center; ">WANSHAN HOUSE PLANS</h1></div>
            <div class="logo">
            ...
            <div class="header_top_right">
                <div class="search_box">
                    <form method="get" action="<?php echo base_url('search')?>">
                        <input type="text" placeholder="Search for House Plans" name="search">
        ...
        <div class="menu">
            <ul id="dc_mega-menu-orange" style="float:left" class="dc_mm-orange">
                ...
                ?>"><a href="<?php echo base_url('/product'); ?>">All House Plans</a> </li>
                ...
                ?>"><a href="<?php echo base_url('/contact'); ?>">Send us Requests</a> </li>
